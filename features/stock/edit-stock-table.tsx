...
const EditStockTable: React.FC = () => {
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => setSearchBar(Pages.stockPage, e.target.value, 'edit')
  ...
  const columns = useMemo(() => createStockColumns({ router, isEditable: true }), [router])
