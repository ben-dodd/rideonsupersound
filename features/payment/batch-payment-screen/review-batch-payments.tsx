              ...
              return (
                ...
                >
                  ...
                  <div className="flex w-1/6">
                    ...
                    {!v?.hasNegativeQuantityItems && !invalidBankAccountNumber && !v?.storeCreditOnly ? (
...
<button
  ...
  onClick={() => {
    ...
    link.setAttribute('download', `batch-payment-${dayjs().format(dateYMD)}.kbb`)
...
<button
  ...
  onClick={() => {
    ...
    var link = document.createElement('a')
    link.setAttribute('href', csvContent)
    link.setAttribute('download', `batch-payment-email-list-${dayjs().format(dateYMD)}.csv`)
    document.body.appendChild(link)
    link.click()
    setEmailed(true)
  }}
